...
# ======================
# ARROW IMAGE (wijst standaard omhoog)
# ======================
...
# ======================
# PIJL SPAWN OFFSET (vanuit boog)
# ======================
ARROW_OFFSET = pygame.Vector2(0, -20)

# ======================
# ARROW CLASS MET ROTATIE
# ======================
class Arrow:
...
while running:
    ...
    for event in pygame.event.get():
        if event.type == pygame.QUIT:
            ...
            if not dead and not paused and event.key == pygame.K_f:
                state = "stab"
                frame_index = 0

        elif event.type == pygame.MOUSEBUTTONDOWN:
            if not dead and not paused and event.button == 1:
    ...
    # ======================
    # UPDATES (niet tijdens pauze of dood)
    # ======================
    ...
    if paused:
        ...
        screen.blit(pause_text,(SCREEN_W//2-pause_text.get_width()//2, SCREEN_H//2-pause_text.get_height()//2))
